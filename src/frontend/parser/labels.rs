...
impl ParserLabel {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CaseStatement => "case statement",
            Self::DefaultStatement => "default statement",
            Self::LabelStatement => "label statement",
            Self::GotoStatement => "goto statement",
    ...
    pub fn from_str(label: &str) -> Option<Self> {
        match label {
            ...
            "switch statement" => Some(Self::SwitchStatement),
            "case statement" => Some(Self::CaseStatement),
            "default statement" => Some(Self::DefaultStatement),
            "label statement" => Some(Self::LabelStatement),
            "goto statement" => Some(Self::GotoStatement),
...
mod tests {
    ...
    fn parser_label_round_trip() {
        let all = [
            ...
            ParserLabel::SwitchStatement,
            ParserLabel::CaseStatement,
            ParserLabel::DefaultStatement,
            ParserLabel::LabelStatement,
            ParserLabel::GotoStatement,
